...
export const courseStructure: Chapter[] = [
  {
    ...
    lessons: [
      { id: "03", title: "First Three.js Project", path: "/03-first-threejs-project" },
      ...
      { id: "07", title: "Fullscreen and Resizing", path: "/07-fullscreen-and-resizing" },
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: "19", title: "Scroll Based Animation", path: "/19-scroll-based-animation" },
    ],
  },
  {
    id: "chapter3",
    ...
    lessons: [
      ...
      { id: "22", title: "Raycaster and Mouse Events", path: "/22-raycaster-and-mouse-events" },
      { id: "23", title: "Custom Models with Blender", path: "/23-custom-models-with-blender" },
      { id: "24", title: "Environment Map", path: "/24-environment-map" },
      { id: "25", title: "Realistic Render", path: "/25-realistic-render" },
      { id: "26", title: "Code Structuring for Bigger Projects", path: "/26-code-structuring-for-bigger-projects" },
    ],
  },
  {
    id: "chapter4",
