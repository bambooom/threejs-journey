...
const Page: FC = () => {
  ...
  useEffect(() => {
    ...
    const gui = new GUI();
    const debugObject = {
      depthColor: '#489ac7', // deeper blue
      surfaceColor: '#9bd8ff', // lighter blue
    };
    ...
    gui.add(waterMaterial.uniforms.uBigWavesSpped, 'value').min(0).max(4).step(0.001).name('uBigWavesSpped');
